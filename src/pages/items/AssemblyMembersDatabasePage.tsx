...
const demoData = [
  {
    ...
    votesCount: "1",
    councilDecisionNumber: "2024/001",
    joinDate: "الخميس 25 صفر 1446هـ، 29 أغسطس 2024",
    memberRole: "رئيس",
    lateSubscriptions: "2",
    eligibleForParticipation: "لا",
    attributes: "عضو مؤسس",
    qualification: "ابتدائي",
    specialization: "إدارة أعمال",
    workEntity: "شركة الرياض",
    jobTitle: "مدير",
    workProvince: "الرياض",
    workCity: "الرياض",
    workDistrict: "العليا",
    workStreet: "شارع التحلية",
    workBuildingNumber: "456",
    workUnitNumber: "10",
    workPostalCode: "54321",
    workAdditionalNumber: "9876",
    createdDate: "الخميس 25 صفر 1446هـ، 29 أغسطس 2024 11:56 ص",
    createdBy: "مدير النظام التقني",
    updatedDate: "السبت 27 صفر 1446هـ، 31 أغسطس 2024 01:32 ص",
...
const columns = [
  ...
  { key: "councilDecisionNumber", label: "رقم قرار المجلس", width: "120px" },
  { key: "joinDate", label: "تاريخ الإنضمام", width: "220px" },
  { key: "memberRole", label: "دور العضو", width: "100px" },
  { key: "lateSubscriptions", label: "الإشتراكات المتأخرة", width: "120px" },
  { key: "eligibleForParticipation", label: "مستحق للمشاركة", width: "120px" },
  { key: "attributes", label: "الصفات", width: "120px" },
  { key: "qualification", label: "المؤهل", width: "100px" },
  { key: "specialization", label: "التخصص او الدراسة", width: "150px" },
  { key: "workEntity", label: "جهة العمل", width: "150px" },
  { key: "jobTitle", label: "المسمي الوظيفي", width: "120px" },
  { key: "workProvince", label: "محافظة العمل", width: "100px" },
  { key: "workCity", label: "مدينة العمل", width: "100px" },
  { key: "workDistrict", label: "حي العمل", width: "100px" },
  { key: "workStreet", label: "شارع العمل", width: "150px" },
  { key: "workBuildingNumber", label: "رقم مبنى العمل", width: "100px" },
  { key: "workUnitNumber", label: "رقم وحدة العمل", width: "100px" },
  { key: "workPostalCode", label: "الرمز بريدي للعمل", width: "120px" },
  { key: "workAdditionalNumber", label: "الرقم الإضافي للعمل", width: "120px" },
  { key: "createdDate", label: "تاريخ الإنشاء", width: "220px" },
  { key: "createdBy", label: "انشأ بواسطة", width: "150px" },
  { key: "updatedDate", label: "تاريخ التحديث", width: "220px" },
  { key: "updatedBy", label: "حدث بواسطة", width: "150px" },
  { key: "accountStatus", label: "حالة الحساب", width: "100px" },
];
...
const AssemblyMembersDatabasePage = () => {
  ...
  const renderCellContent = (row: typeof demoData[0], columnKey: string) => {
    ...
    if (columnKey === "accountStatus") {
      const status = row.accountStatus;
      return (
        <Badge variant={status === "مفعل" ? "default" : "secondary"} className={status === "مفعل" ? "bg-emerald-600" : ""}>
          {status}
        </Badge>
      );
    }
    if (columnKey === "eligibleForParticipation") {
      const value = row.eligibleForParticipation;
      return (
        <Badge variant={value === "نعم" ? "default" : "secondary"} className={value === "نعم" ? "bg-emerald-600" : "bg-red-500 text-white"}>
          {value}
        </Badge>
      );
    }
