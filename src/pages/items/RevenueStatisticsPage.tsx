...
import { TrendingUp, Search, ChevronDown, Settings } from "lucide-react";
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">إحصائيات الإيرادات</h1>
            <p className="text-muted-foreground">تحليل وعرض إحصائيات الإيرادات</p>
          </div>
        </div>
