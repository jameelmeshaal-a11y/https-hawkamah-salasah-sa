...
import { RotateCcw, Search, Filter, RefreshCw, Eye } from "lucide-react";
...
const RestoreShareholderAccountPage = () => {
  const columns = [
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">إستعادة حساب مساهم</h1>
          </div>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={columns.length}>
                      <EmptyState message="لا يوجد حسابات ملغاة" />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
...
export default RestoreShareholderAccountPage;
