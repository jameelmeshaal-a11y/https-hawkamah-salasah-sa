...
import { UserX, Search, Filter, RefreshCw, XCircle, Eye } from "lucide-react";
...
const CancelShareholderAccountPage = () => {
  const columns = [
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">إلغاء حساب مساهم</h1>
          </div>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={columns.length}>
                      <EmptyState message="لا يوجد مساهمين" />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
...
export default CancelShareholderAccountPage;
