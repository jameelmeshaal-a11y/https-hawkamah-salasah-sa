...
const CostCenterStatementReportPage = () => {
  ...
  const dummyData: CostCenterEntry[] = [
    ...
    },
    {
      date: "05/07/1447",
      entryNumber: "QID-002",
      description: "مصروفات إيجار المبنى",
      debit: 15000,
      credit: 0,
      balance: 40000,
    },
  ...
  return (
    <InnerPageLayout moduleId="financial-affairs" moduleTitle="إدارة الشؤون المالية" title="تقرير كشف مركز تكلفة">
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">تقرير كشف مركز تكلفة</h1>
          </div>
...
export default CostCenterStatementReportPage;
