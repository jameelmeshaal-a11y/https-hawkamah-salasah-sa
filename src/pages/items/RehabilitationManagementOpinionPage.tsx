...
const RehabilitationManagementOpinionPage = () => {
    ...
    <InnerPageLayout moduleId={moduleId || "projects"}>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">رأي إدارة التأهيل</h1>
            <p className="text-muted-foreground text-sm">
              إضافة وإدارة آراء إدارة التأهيل على المشاريع
            </p>
          </div>
        </div>
...
export default RehabilitationManagementOpinionPage;
