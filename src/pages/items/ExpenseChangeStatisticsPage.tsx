...
import { ArrowDownRight, Search, ChevronDown, Settings } from "lucide-react";
import ReportExportButtons from "@/components/reports/ReportExportButtons";

const ExpenseChangeStatisticsPage = () => {
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">إحصائيات تغير المصروفات</h1>
            <p className="text-muted-foreground">تحليل وعرض معدلات تغير المصروفات</p>
          </div>
        </div>
...
export default ExpenseChangeStatisticsPage;
