...
import { TrendingDown, Search, ChevronDown, Settings } from "lucide-react";
...
const ExpensesStatisticsPage = () => {
  ...
  const [verticalData, setVerticalData] = useState<string[]>(["period"]);
  ...
  const toggleVerticalData = (value: string) => {
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">إحصائيات المصروفات</h1>
            <p className="text-muted-foreground">تحليل وعرض إحصائيات المصروفات</p>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label className="text-foreground font-medium">
                  البيانات الرأسية <span className="text-red-500">*</span>
                </Label>
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="v-period"
                      checked={verticalData.includes("period")}
                      onCheckedChange={() => toggleVerticalData("period")}
                    />
                    <Label htmlFor="v-period" className="cursor-pointer">الفترة</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="v-type"
                      checked={verticalData.includes("type")}
                      onCheckedChange={() => toggleVerticalData("type")}
                    />
                    <Label htmlFor="v-type" className="cursor-pointer">النوع</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="v-payment"
                      checked={verticalData.includes("payment")}
                      onCheckedChange={() => toggleVerticalData("payment")}
                    />
                    <Label htmlFor="v-payment" className="cursor-pointer">وسيلة الدفع</Label>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="h-period"
                      checked={horizontalData.includes("period")}
                      onCheckedChange={() => toggleHorizontalData("period")}
                    />
                    <Label htmlFor="h-period" className="cursor-pointer">الفترة</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox
                      id="h-type"
