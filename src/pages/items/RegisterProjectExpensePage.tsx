...
const RegisterProjectExpensePage = () => {
  ...
  return (
    <InnerPageLayout moduleId="projects-management" title="تسجيل صرف مشروع" moduleTitle="إدارة المشاريع" sectionTitle="مرحلة التنفيذ">
      <div className="p-6 space-y-4">
        ...
        <ProjectsTable data={projectsData} actionType="manage" actionLabel="تسجيل مصروف" actionColor="blue" onAction={handleAction} />
      </div>
      <RegisterFinancialDialog open={dialogOpen} onOpenChange={setDialogOpen} type="expense" projectName={selectedProject} />
    </InnerPageLayout>
  );
};

export default RegisterProjectExpensePage;
